...
@section('content')
  ...
  <div class="row gutters-20">
    <div class="col-12 col-xl-12 col-12-xxxl">
      @component('components.tables.recipes.category.recipe-categories',['recipe_categories' => $recipe_categories,'statistics'=>$statistics, 'canDo' => $canDo ])
        recipe-categories-table Component
      @endcomponent
    </div>
  </div>
@endsection
