...
@section('content')
  ...
  <div class="breadcrumbs-area">
    ...
    <ul>
      <li>
        <a href="{{ route('faq_category.index') }}">Home</a>
      </li>
      <li>Team Details</li>
    </ul>
  </div>
      ...
      <div class="card ui-tab-card">
        <div class="card-body p-0">
          <div class="border-nav-tab">
              @if( in_array('category_update', $canDo) )
                <li class="nav-item">
                  <a class="nav-link" 
                    href="{{ route('faq_category.edit', ['id' => $category->id ]) }}"  
                    aria-selected="false"
                  > 
                    Edit
                  </a>
                ...
                <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                  <div class="card-body">
                    ...
                    <div class="single-info-details">
                      <div class="item-img">
                        <img src="{{URL::asset('assets/images/faqs/category/'.$category->avatar)}}" alt="no image">
                      </div>
                      <div class="item-content">
                        <div class="header-inline item-header">
                          ...
                          <div class="header-elements">
                            <ul>
                              @if(isset($storeBelongs) && $storeBelongs && in_array('faq_category_update', $canDo))
                        ...
                        <table class="table text-nowrap">
                          <tbody>
                            ...
                            {{--  --@if($team->hasProject())
                              <tr>
                                  <td>Project:</td>
                                  <td class="font-medium text-dark-medium">{{ $category->project->name}}</td>
                              </tr>
                            @endif --}}
                          </tbody>
                        </table>
