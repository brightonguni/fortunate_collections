...
@section('content')
  ...
  <div class="row gutters-20">
    <div class="col-12 col-xl-12 col-12-xxxl">
      @component('components.tables.recipes.methods.recipe-methods',['recipe_methods' => $recipe_methods,'statistics'=>$statistics, 'canDo' => $canDo ])
        services-categories-table Component
      @endcomponent
    </div>
  </div>
@endsection
