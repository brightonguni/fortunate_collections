@if($categories)
  <div class="card-header">
    <h3 class="text-hover">Blog Categories</h3>
  </div>
                  ...
                  <div class="row">
                    <div class="col-xs-12 col-sm-12 col-lg-md-12 col-lg-12 text-center">
                      <img class ="category-image img-responsive img-thumbnail m-0 p-0 w-100"style="height: 100px; width: 100%;" 
                        src="{{ URL::asset('assets/images/blogs/category/'.$category->avatar) }}"
                         alt="{{ $category->avatar }}"
                      >
                    </div>
                  </div>
  ...
  <div class="row pt-1 pb-2">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <a class="btn btn-md gradient-dodger-black btn-block" href="{{ route('web_blog_category.index') }}">Find Out More</a>
    </div>
  </div>
@endif