...
@section('content')
    ...
    <div class="breadcrumbs-area">
        ...
        <ul>
            ...
            <li>
                <a href="/teams/{{ $team->id }}">Details</a>
            </li>
            <li>Edit Team</li>
        </ul>
    </div>
        ...
        <div class="col-md-12">
            <div class="card ui-tab-card">
                <div class="card-body p-4">
                    ...
                    <h5 class="card-title mt-1">Update Team Details</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card ui-tab-card">
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                        <div class="card-body">
                            @component('components.forms.teams.edit',[ 'team' => $team, 'roles' => $roles, 'licensors' => $licensors, 'stores' => $stores ,'projects' => $projects])
