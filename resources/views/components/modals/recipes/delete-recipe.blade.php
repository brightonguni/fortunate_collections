<!-- Delete User Modal -->
<div class="modal fade" id="delete-blog" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div role="alert" class="alert p-0 p-4">
                      ...
                      <form method="POST" action="{{ route('blog.delete','id') }}">
                        <div class="text-center message-box-wrap">
                          ...
                          <h4 class="my-3">Are you sure you want to delete this Blog?</h4>
                          <p>If you delete, you will permanently lose your data</p>
                          <button type="button submit" id="delete-btn" data-target-id="null"
                            class="delete_btn btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Delete
                          </button>
                        </div>
                      </form>
                    </div>
