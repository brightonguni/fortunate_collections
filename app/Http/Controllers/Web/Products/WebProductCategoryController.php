...
class WebProductCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('web.pages.products.categories.index', compact('product_page', 'blog_page', 'stores', 'service_categories', 'products', 'categories', 'services', 'blogs', 'events'));
    }
    ...
    public function show($id)
    {
        ...
        return view('web.pages.products.categories.show', compact('product_page', 'blog_page', 'faqs', 'service_categories', 'stores', 'products', 'categories', 'productByCategories', 'category', 'services', 'blogs', 'events'));
