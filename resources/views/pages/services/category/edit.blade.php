...
@section('content')
    ...
    <div class="breadcrumbs-area">
        ...
        <ul>
            ...
            <li>
                <a href="/service-category/{{ $service_category->id }}">Details</a>
            </li>
            <li>Edit Category</li>
        </ul>
    </div>
            ...
            <div class="card ui-tab-card">
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                        <div class="card-body">
                            @component('components.forms.services.category.edit',[ 'service_category' => $service_category,'stores'=>$stores,'licensors'=>$licensors, 'canDo' => $canDo])
