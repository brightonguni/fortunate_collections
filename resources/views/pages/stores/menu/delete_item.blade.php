<div class="modal-dialog">
    <div class="modal-content">    
        ...
        <div class="modal-body">
            ...
            <form class="pt-2" data-async  id="createMenuItem" action="{{route('store.deleteMenuItem')}}" novalidate _lpchecked="1" >
              ...
              <div class="col-md-12">
                <div class="form-row">
                    <div class="form-group col-12 m-0 pt-3">
                          <p class="text-center">Are sure you want to delete this item?</p>
