...
class PackageCategoryController extends Controller
{
    ...
    public function __construct(CaseStudyRepository $repository, FaqPageRepository $faqPageRepository,
        ...
        ServiceCategoryRepository $serviceCategoryRepository, PackageCategoryRepository $packageCategoryRepository, BlogPageRepository $blogPageRepository,
    ...
    public function index()
    {
        ...
        return view('web.pages.packages.categories.index', compact('blog_page', 'package_categories', 'case_studies', 'faq_page', 'stores', 'service_categories', 'products', 'events', 'faq_categories',  'blogs', 'services'));
    }
    ...
    {
        $case_studies = $this->case_study->index();
        $faq_category = $this->category->index();
        ...
        return view('web.pages.faqs.categories.show', compact('blog_page', 'faq_page', 'package_category', 'stores', 'service_categories', 'faq_categories', 'faqByCategories', 'products', 'events', 'case_studies', 'faq_category', 'blogs', 'services'));
