...
<div class="card height-auto" id="index-card">
  <div class="card-body">
    <form class="pt-2"  id="createRecipeMethodForm" action="{{route('recipe_method.store')}}"  method="POST" enctype="multipart/form-data">
      @csrf
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
          ...
          <div class="form-row">
            <div class="form-group col-12 m-0 pt-3">
                <label for="description" class="col-form-label s-12">Type your Method item (step) *</label>
