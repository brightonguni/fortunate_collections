...
<div id="blog-category-carousel" class="carousel slide">
  <!-- INDICATORS -->
  <ol class="carousel-indicators">
    @foreach($blogs as $slide)
      <li data-target="#blog-category-carousel" data-slide-to="{{ $loop->index }}" class="{{ $loop->first ? 'active' : '' }}"></li>
    @endforeach
  </ol>
  <div class="carousel-inner m-0 p-0">
    @foreach($blogs as $slide)
      <div class="carousel-item slide-item-image {{ $loop->first ? ' active' : '' }} fade-in" style="background-image: url('{{ asset('assets/images/blogs/'.$slide->avatar)}}');" 
  ...
  <a class="left carousel-control" href="#blog-category-carousel" data-slide="prev">
    <span class="glyphicon glyphicon-chevron-left"></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="right carousel-control" href="#blog-category-carousel" data-slide="next">
