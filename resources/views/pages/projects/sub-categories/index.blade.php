      ...
      <div class="card ui-tab-card">
        <div class="tab-content">
          <div class="tab-pane fade show active" id="tab1" role="tabpanel">
            <div class="card-body">
              @component('components.tables.projects.sub-category.sub-categories',['stores' => $stores,'categories'=>$categories,'licensors' => $licensors,'canDo' => $canDo,'sub_categories'=>$sub_categories])
