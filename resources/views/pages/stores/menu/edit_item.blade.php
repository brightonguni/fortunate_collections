<div class="modal-dialog">
    <div class="modal-content">    
        ...
        <div class="modal-body">
            ...
            <form class="pt-2" data-async  id="createMenuItem" action="{{route('store.updateMenuItem')}}" novalidate _lpchecked="1" >
                    ...
                    <div class="form-group col-12 m-0 pt-3">
                                ...
                                <select class="form-control" name="product_id" id="product_id">
                                  <option value="">Select Product</option>
                                    @foreach($products as $product)
                                      @if($storeItem->product_id == $product->id )
                        ...
                        <div class="form-group col-12 m-0 pt-3">
                           <div class="form-group">
                            ...
                            <input id="stock"  min="0" name="stock" value="{{ $storeItem->stock }}" autofocus placeholder="{{'Stock'}}" maxlength="50"
                           ...
                           <div class="form-group">
                            ...
                            <div class="material-switch">
                              @if($storeItem->active == 1)
                                <input id="activate_status" name="status" value="{{$storeItem->active }}" checked="true" type="checkbox">
                              @else
                                 <input id="activate_status" name="status" value="{{$storeItem->active}}" type="checkbox">
                              @endif
                      ...
                      <input type="hidden" name="item_id" id="item_id" value="{{ $storeItem->id }}">
