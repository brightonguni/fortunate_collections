  ...
  <div class="breadcrumbs-area">
    <h3>Product</h3>
      <ul>
        ...
        <li>
            <a href="{{route('product.show', [ 'id' => $product->id ])}}">Details</a>
        </li>
        <li>Edit project</li>
      </ul>
  </div>
            ...
            <div class="card ui-tab-card">
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                        <div class="card-body">
                            @component('components.form.products.edit',['product' => $product, 'brands'=> $brands,'colors' => $colors,'stores' => $stores, 'categories'=>$categories ,'sub_categories'=>$sub_categories,'licensors' => $licensors,'canDo' => $canDo])
