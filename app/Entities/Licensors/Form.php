<?php
namespace App\Entities\Licensors;
...
class Form implements FormInterface
{
    ...
    public function validation($email_rules = 'required|email|unique:users')
    {
        ...
        $validator = tap(Validator::make($data,[
            ...
            "role_id"  => ($mainrole_allowed) ? 'required|numeric' : 'required|numeric'.'|in:2,3,4' ,
...
//            'licensor_id.digits' => 'Phone Number can only contain numeric values.',
