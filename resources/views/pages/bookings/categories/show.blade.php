...
@section('content')
  ...
  <div class="breadcrumbs-area">
    <h3>Booking Category Summary</h3>
    <ul>
      <li>
        <a href="{{ route('booking.category.index') }}">Home</a>
      </li>
      <li>Booking Category Details</li>
    </ul>
  </div>
          ...
          <div class="border-nav-tab">
            <ul class="nav nav-tabs" role="tablist">
              ...
              @if( in_array('team_update', $canDo) )
                <li class="nav-item">
                  <a class="nav-link" 
                    href="{{ route('booking.category.edit', ['id' => $category->id ]) }}"  
                    aria-selected="false"
                  > 
                    Edit
                  </a>
                      ...
                      <div class="item-content">
                        <div class="header-inline item-header">
                          ...
                          <div class="header-elements">
                            <ul>
                              @if(isset($storeBelongs) && $storeBelongs && in_array('booking_category_update', $canDo))
                                <li><a href="{{ $category->id }}/edit"><i class="far fa-edit"></i></a></li>
                              @endif
                              @if(isset($storeBelongs) && $storeBelongs && in_array('booking_category_delete', $canDo))
                      ...
                      <div class="info-table table-responsive">
                        <table class="table text-nowrap">
                          <tbody>
                            ...
                            <tr>
                              <td>category Name:</td>
                              <td class="font-medium text-dark-medium">{{ $category->name }}</td>
                            </tr>
                            <tr>
                              <td>Description:</td>
