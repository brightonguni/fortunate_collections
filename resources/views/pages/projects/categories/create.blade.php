        ...
        <div class="card ui-tab-card">
          <div class="tab-content">
            <div class="tab-pane fade show active" id="tab1" role="tabpanel">
              <div class="card-body">
                @component('components.forms.projects.category.create',[ 'licensors'=>$licensors,'project_category'=> $project_category,'stores'=>$stores, 'canDo' => $canDo])
                    project Category Create Form Component
                @endcomponent
              </div>
            </div>
          </div>
