  ...
  <div class="breadcrumbs-area">
    <h3> Edit Product Category</h3>
      <ul>
        ...
        <li>
            <a href="{{route('product_brand.show', [ 'id' => $brand->id ])}}">Details</a>
        </li>
        <li>Edit project</li>
      </ul>
  </div>
            ...
            <div class="card ui-tab-card">
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                        <div class="card-body">
                            @component('components.forms.products.brands.edit',['brand' => $brand, 'stores' => $stores,'licensors' => $licensors,'canDo' => $canDo])
