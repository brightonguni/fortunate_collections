          ...
          <div class="border-nav-tab">
            <ul class="nav nav-tabs" role="tablist">
              ...
              @if( in_array('case_study_update', $canDo) )
                <li class="nav-item">
                  <a class="nav-link" 
                    href="{{ route('case_study.edit', ['id' => $case_study->id ]) }}"  
                    aria-selected="false"
                  > 
                    Edit
                  </a>
                      ...
                      <div class="item-content">
                        <div class="header-inline item-header">
                          ...
                          <div class="header-elements">
                            <ul>
                              @if(isset($storeBelongs) && $storeBelongs && in_array('case_study_update', $canDo))
                                <li><a href="{{ $case_study->id }}/edit"><i class="far fa-edit"></i></a></li>
                              @endif
                              
                              @if(isset($storeBelongs) && $storeBelongs && in_array('case_study_delete', $canDo))
                                <li><a class="dropdown-item" data-target-id="{{$case_study->id}}" data-toggle="modal" data-target="#delete"><i class="fas fa-trash-alt"></i></a></li>
                              @endif
                            </ul>
                          </div>
                        </div>
                      <div class="info-table table-responsive">
                        <table class="table text-nowrap">
                          <tbody>
                            ...
                            <tr>
                              <td>Category:</td>
                              <td class="font-medium text-dark-medium">{{ $case_study->case_study_category_id }}</td>
                            </tr>
                            <tr>
                              <td>Description:</td>
                            ...
                            <tr>
                              <td>Status:</td>
                              <td class="font-medium text-dark-medium">{{ ($case_study->active)? 'Active' : 'Suspended'}}</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
