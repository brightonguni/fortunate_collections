...
<div class="card height-auto" id="index-card">
  <div class="card-body">
    <form class="pt-2"  id="createProductSubCategoryForm" action="{{route('product_sub_category.store')}}"  method="POST" enctype="multipart/form-data">
      @csrf
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
          ...
          <div class="form-row mt-1">
            <div class="form-group col-12 m-0">
                <label class="my-1 mr-2 pt-3" for="category_id">Product Category * <span class="ml-3">Categories to mach to, must be created first</span></label>
