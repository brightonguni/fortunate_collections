    ...
    <div class="card ui-tab-card">
      <div class="tab-content">
        <div class="tab-pane fade show active" id="tab1" role="tabpanel">
          <div class="card-body">
            <form class="pt-2"  id="createBlogcategoryForm" action="{{route('faq_category.store')}}" enctype="multipart/form-data" method="POST">
              @csrf
              @if ($errors->any())
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                  <div class="form-row">
                    <div class="form-group col-12">
                      <label for="avatar">browse  Faq category image
