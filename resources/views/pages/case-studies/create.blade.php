        ...
        <div class="col-md-12">
            <div class="card ui-tab-card">
                <div class="card-body p-4">
                    ...
                    <h5 class="card-title mt-1">Create acase study</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card ui-tab-card">
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                        <div class="card-body">
                            @component('components.forms.case-studies.create',[ 'categories' => $categories, 'canDo' =>$canDo ])
                                case-study Create Form Component
                            @endcomponent
                        </div>
                    </div>
                </div>
