        ...
        <div class="card-body p-0">
          <div class="border-nav-tab">
            <ul class="nav nav-tabs" role="tablist">
              <li class="nav-item">
                  <a class="nav-link active" data-toggle="tab" href="#events" role="tab" aria-selected="true">Active events</a>
              </li>
              @if( in_array('booking_event_list', $canDo) )
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#event_types" role="tab" aria-selected="false">suspended events</a>
                </li>
              @endif
              <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="#tab5" role="tab" aria-selected="false">Blocked Events</a>
              </li>
              </ul>
            </div>
          </div>
