...
@section('content')
  ...
  <div class="row gutters-20">
    <div class="col-12 col-xl-12 col-12-xxxl">
      @component('components.tables.case-studies.categories.categories',[ 'canDo' => $canDo ,'statistics' => $statistics,'categories' => $categories])
        case-studies-categories-table Component
      @endcomponent
    </div>
  </div>
@endsection
