...
@section('content')
  ...
  <div class="breadcrumbs-area">
    ...
    <ul>
      <li>
        <a href="{{ route('case_study_category.index') }}">Home</a>
      </li>
        ...
        <div class="card-body p-0">
          <div class="border-nav-tab">
            <ul class="nav nav-tabs" role="tablist">
              <li class="nav-item">
                  <a class="nav-link active" data-toggle="tab" href="#tab1" role="tab" aria-selected="true">Case Studies</a>
              </li>
              <li class="nav-item">
                  <a class="nav-link" data-toggle="tab" href="#credit-card" role="tab" aria-selected="false">categories</a>
              </li>
              
              @if( in_array('case_study_category_update', $canDo) )
                <li class="nav-item">
                  <a class="nav-link" 
                    href="{{ route('case_study_category.edit', ['id' => $category->id ]) }}"  
                    aria-selected="false"
                  > 
                    Edit
                  </a>
