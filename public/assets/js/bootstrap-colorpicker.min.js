...
}("undefined" != typeof self ? self : this, function (e)
{
			...
			s = function ()
			{
				...
				}]), n(e, [
				{
					...
					value: function (t)
					{
						...
						if (o = e.sanitizeFormat(o), this._original = {
								...
								format: o,
								valid: !0
							}, this._color = e.parse(t), null === this._color) return this._color = (0, a.default)(), void(this._original.valid = !1);
				...
				}], [
				{
					...
					value: function (t)
					{
						...
						var o = null;
						if (null === (t = t instanceof l ? [t.h, t.s, t.v, isNaN(t.a) ? 1 : t.a] : e.sanitizeString(t))) return null;
				...
				return n(e, [
				{
					...
					value: function (e, t)
					{
						if (this.currentSlider)
						{
							...
							o.guideStyle.left = t + "px", o.guideStyle.top = e + "px", o.callLeft && i[o.callLeft](t / o.maxLeft), o.callTop && i[o.callTop](e / o.maxTop), r.setValue(i), r.popupHandler.focus()
						}
					}
				},
				{
							...
							if (!o.is(".colorpicker"))
							{
								...
								for (var n in r)
									if (r.hasOwnProperty(n))
									{
										...
										if (o.is(i.selector))
										{
											this.currentSlider = a.default.extend(
											{}, i,
											{
												name: n
											});
		...
		var i = function ()
			...
			u = function ()
			{
				...
				},
				{
					...
					{
						var e = this.colorpicker;
						this.popoverTarget = this.hasAddon ? this.addon : this.input, e.picker.addClass("colorpicker-bs-popover-content"), this.popoverTarget.popover(l.default.extend(!0,
						{}, c.default.popover, e.options.popover,
						{
							trigger: "manual",
							content: e.picker,
							html: !0
	...
	}, function (e, t, o)
	{
		...
		function r(e, t)
		{
			...
			else if (e instanceof r) this.model = e.model, this.color = e.color.slice(), this.valpha = e.valpha;
	...
	}, function (e, t, o)
	{
		...
		}, c.get.hsl = function (e)
		{
			...
			if (o)
			{
				...
				return [(parseFloat(o[1]) + 360) % 360, r(parseFloat(o[2]), 0, 100), r(parseFloat(o[3]), 0, 100), r(isNaN(n) ? 1 : n, 0, 1)]
			}
			return null
			...
			u = function ()
			{
				...
				},
				{
					...
					value: function ()
					{
						...
						return t.isValid() ? t : (console.warn("The fallback color is invalid. Falling back to the previous color or black if any."), this.color ? this.color : new c.default("#000000", this.format))
					}
				},
				{
					key: "assureColor",
