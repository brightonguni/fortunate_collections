    ...
    <div class="card">
      <div class="card-header">Update Service Details</div>
        <div class="card-body">
          <form class="pt-2"  id="createServiceForm" action="{{route('service.update',['id' => $service->id])}}"  method="POST" enctype="multipart/form-data">
            @csrf
            <input type="text" name="service_id" hidden="hidden" value="{{ $service->id }}">
            <div class="row">
              <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                <div class="form-row">
                  <div class="col-xs-12 col-sm-12 col-md-12  col-lg-12  service-avatar pl-0">
                    <input  type="file" id="service-avatar" name="avatar" value="{{ $service->avatar }}">
                    <div class="dropzone dropzone-file-area pt-4 pb-4 dz-clickable" id="service-avatar">
                     ...
                     <img  style="background-color: #eee" class="text-center" src="{{ URL::asset('assets/images/services/'.$service->avatar) }}" />
                  </div>
                </div>
              </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-row">
                      <div class="form-group col-12 m-0 pt-3">
                        ...
                        <input id="title" name="title" autofocus placeholder="{{ $service->title }}"
                          value="{{ $service->title }}" maxlength="191"  
                      ...
                      <div class="form-row mt-1">
                        <div class="form-group col-12 m-0">
                          ...
                          <select name="licensor_id" required class="select2 my-1  form-control r-0 light " id="licensor_id">
                            <option value="{{ $service->store->name }}">{{ $service->store->name }}</option>
