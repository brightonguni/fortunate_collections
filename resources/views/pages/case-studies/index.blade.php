...
@section('content')
        ...
        <div class="card-body p-0">
          <div class="border-nav-tab">
            <ul class="nav nav-tabs" role="tablist">
              <li class="nav-item">
                  <a class="nav-link active" data-toggle="tab" href="#tab1" role="tab" aria-selected="true">Categories</a>
              </li>
              @if( in_array('case_study_list', $canDo) )
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#comments" role="tab" aria-selected="false">Comments</a>
                </li>
              @endif
 ...
 <div class="row gutters-20">
    <div class="col-12 col-xl-12 col-12-xxxl">
      @component('components.tables.case-studies.case_studies',['case_studies' => $case_studies, 'canDo'=> $canDo, 'categories' => $categories, 'statistics' => $statistics])
