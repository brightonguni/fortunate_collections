...
@section('content')
        ...
        <div class="card-body p-0">
          <div class="border-nav-tab">
            <ul class="nav nav-tabs" role="tablist">
              <li class="nav-item">
                  <a class="nav-link active" data-toggle="tab" href="#venues" role="tab" aria-selected="true">Venue</a>
              </li>
              @if( in_array('venue_type_list', $canDo) )
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#venue_types" role="tab" aria-selected="false">Bookings</a>
                </li>
              @endif
              <li class="nav-item">
  ...
  <div class="row gutters-20">
    <div class="col-12 col-xl-12 col-12-xxxl">
      @component('components.tables.bookings.venues.venues',[ 'canDo' => $canDo ,'venues' => $venues])
