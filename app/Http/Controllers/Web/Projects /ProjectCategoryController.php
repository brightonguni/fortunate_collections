...
class ProjectCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('web.pages.projects.categories.index', compact('projects', 'project_page', 'service_categories', 'stores', 'products', 'categories', 'services', 'blogs', 'blog_page', 'events'));
    }
    ...
    public function show($id)
    {
        ...
        return view('web.pages.projects.categories.show', compact('projects', 'project_page', 'blog_page', 'service_categories', 'faqs', 'stores', 'products', 'categories', 'projectByCategories', 'category', 'services', 'blogs', 'events'));
