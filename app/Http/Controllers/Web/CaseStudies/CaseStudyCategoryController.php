...
class CaseStudyCategoryController extends Controller
{
    ...
    public function __construct(CaseStudyRepository $repository,
        ...
        $this->category = $caseStudyCategoryRepository;
    ...
    public function index()
    {
        ...
        return view('web.pages.case-studies.index', compact('stores', 'products', 'events', 'categories', 'case_studies', 'categories', 'blogs', 'services'));
    }
    ...
    public function show($id)
    {
        ...
        return view('web.pages.case-studies.categories.show', compact('stores', 'products', 'events', 'case_studies', 'category', 'blogs', 'services'));
