          ...
          <div class="border-nav-tab">
            <ul class="nav nav-tabs" role="tablist">
              ...
              @if( in_array('booking_event_update', $canDo) )
                <li class="nav-item">
                  <a class="nav-link" 
                    href="{{ route('booking_event.edit', ['id' => $event->id ]) }}"  
                    aria-selected="false"
                  > 
                    Edit
                  </a>
                      ...
                      <div class="item-content">
                        <div class="header-inline item-header">
                          ...
                          <div class="header-elements">
                            <ul>
                              @if(isset($storeBelongs) && $storeBelongs && in_array('booking_event_update', $canDo))
                                <li><a href="{{ $event->id }}/edit"><i class="far fa-edit"></i></a></li>
                              @endif
                              @if(isset($storeBelongs) && $storeBelongs && in_array('booking_event_delete', $canDo))
                                <li><a class="dropdown-item" data-target-id="{{$event->id}}" data-toggle="modal" data-target="#delete"><i class="fas fa-trash-alt"></i></a></li>
                              @endif
                        ...
                        <table class="table text-nowrap">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="font-medium text-dark-medium">{{ $event->start_date }}</td>
                            </tr>
                            <tr>
                              <td>event Ending Date:</td>
                              <td class="font-medium text-dark-medium">{{ $event->end_date }}</td>
                            </tr>
                            <tr>
                              <td>Venue:</td>
                            ...
                            <tr>
                              <td>Status:</td>
                              <td class="font-medium text-dark-medium">{{ ($event->active)? 'Active' : 'Suspended'}}</td>
                            </tr>
                            {{-- @if($event->hasLicensor())
                              <tr>
                                  <td>Licensor:</td>
                                  <td class="font-medium text-dark-medium">{{ $event->licensor->name}}</td>
                              </tr>
                            @endif
                            @if($event->hasStore())
                              <tr>
                                  <td>Store:</td>
                                  <td class="font-medium text-dark-medium">{{ $event->store->name}}</td>
                              </tr>
                            @endif --}}
                            {{-- @if($event->hasService())
                              <tr>
