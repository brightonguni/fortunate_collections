        ...
        <div class="col-md-12">
            <div class="card ui-tab-card">
                <div class="card-body p-4">
                    ...
                    <h5 class="card-title mt-1">Create a Skill</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card ui-tab-card">
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                        <div class="card-body">
                            @component('components.forms.skills.create',[ 'licensors' => $licensors, 'skill_levels'=>$skill_levels,'stores' => $stores,'statistics' => $statistics ,'canDo'=>$canDo])
