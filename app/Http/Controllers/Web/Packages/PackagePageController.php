...
class WebFaqPageController extends Controller
{
    ...
    public function __construct(
        ...
        BlogPageRepository $blogPageRepository, PackagePageRepository $packagePageRepository,
    ...
    public function index()
    {
        ...
        return view('web.pages.faqs.index', compact('faq_page', 'package_page', 'packages', 'service_categories', 'stores', 'products', 'blog_page', 'events', 'case_studies', 'blogs', 'categories', 'services'));
    }
    ...
    public function show($id)
    {
        ...
        $stores = $this->store->index();
        $service_categories = $this->service_category->index();
        return view('web.pages.blogs.show', compact('faq_page', 'package_page', 'packages', 'blogPage', 'stores', 'service_categories', 'products', 'blog_page', 'comments', 'categories', 'events', 'blog', 'relatedBlog', 'blogs', 'services'));
