@if($faq_categories)
  <div class="card-header">
    <h3 class="text-hover">FAQs Categories</h3>
  </div>
  @foreach($faq_categories->take(4) as $category)
    <a href="{{ route('web_faq_category.show',['id' => $category->id]) }}">
      <div class="row">
  ...
  <div class="row pt-1 pb-2">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <a class="btn btn-lg  btn-outline-light btn-block" href="{{ route('web_faq_category.index') }}"><strong>Find Out More</strong></a>
    </div>
  </div>
@endif