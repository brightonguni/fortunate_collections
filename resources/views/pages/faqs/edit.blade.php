        ...
        <div class="col-md-12">
            <div class="card ui-tab-card">
                <div class="card-body p-4">
                    ...
                    <h5 class="card-title mt-1">Update faq Details</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card ui-tab-card">
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                        <div class="card-body">
                            @component('components.forms.faqs.edit',[ 'faq' => $faq, 'roles' => $roles, 'canDo' => $canDo])
                                faqs Edit Form Component
                            @endcomponent
                        </div>
                    </div>
                </div>
