...
use App\Model\Stores\StoreCategory;
...
class StoreCategoryRepository extends Form implements RepositoryInterface
{
    ...
    public function all()
    {
        return StoreCategory::all()->sortByDesc('created_at');
    }
...
//        Session::flash('errors',self::errors());
    ...
    public function store(array $category)
    {
        ...
        if (isset($category['icon_id'])) {
            $category['icon'] = $category['icon_id'];
        }

        $category = StoreCategory::create($category);
        return $category;
    }
