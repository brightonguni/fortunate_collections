...
<div class="card height-auto" id="index-card">
  <div class="card-body">
    <form class="pt-2"  data-async data-target="#edit"  id="editProductCategoryForm" 
      action="{{route('product_category.update',['id' => $product_category->id])}}"  
      method="POST" enctype="multipart/form-data" novalidate_lpchecked="1"
    >
      @csrf 
      {{-- <input name="_method" type="hidden" value="PUT" /> --}}
      <input type="text" name="product_category_id" value="{{ $product_category->id }}" hidden="hidden">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 pt-4">
          {{-- <div class="col-md-12 service-avatar pl-0"> --}}
            <input  type="file" id="avatar" name="avatar" value="{{ $product_category->avatar }}">
            ...
            <div class="category-image"><img src="{{ URL::asset('assets/images/products/category/'. $product_category->avatar )}}"></div>
          {{-- </div> --}}
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
          <div class="form-row">
            <div class="form-group col-12 m-0 pt-3">
              ...
              <input id="title" name="title" autofocus placeholder="{{ $product_category->title}}"
                value="{{ $product_category->title}}" maxlength="191"  required type="text"
                class="form-control 
                r-0 light s-12  
