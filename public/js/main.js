...
(function($) {
    ...
    $('#service-avatar-up').on('click', function() {
        $('#service_avatar').trigger('click');
    });
    ...
    $('#product-avatar').on('click', function() {
        $('#avatar').trigger('click');
    });
    $('#blog-avatar').on('click', function() {
        $('#avatar').trigger('click');
    });
    ...
    $('#product-avatar-up').on('click', function() {
        $('#product_avatar').trigger('click');
    });
    ...
    $(function() {
        ...
        /*-------------------------------------
              Delete
          -------------------------------------*/
        $("#delete-service").on('click', '.delete', function() {
            let id = $(this).attr('data-id');
            $('#id').val(id);
        });
        //<a href="{{'#'}}" class="delete-blog-modal" data-value="{{$blog['id']}}" data-toggle="modal" data-target="#myModal">Delete</a>
        $("#delete-blog").on("click", ".delete-blog-modal", function(e) {
            var delete_blog_id = $(this).attr('data-value');
            $('button[name="delete_blog"]').val(delete_blog_id);
        });
