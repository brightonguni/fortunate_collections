            	...
            	<div class="flipper">
                        ...
                        <div class="col-12 p-0">
                          <div class="product-categories style="height: 50px;" text-left p-0 m-0">
                            <ul>
                              ...
                              <li style="font-weight: 200;" class="btn  btn-outline-dark btn-sm text-capitalize p-1 m-1">{{ str_limit($category->title,'15') }}</li>
                              @endforeach
                            </ul>
                          </div>
                          ...
                          <div class="product-sub-categories" style="height: 50px;">
                            <ul>
                              ...
                              <li  style="font-weight: 200;" class="btn  btn-outline-dark btn-sm text-capitalize p-1 m-1">{{ str_limit($sub_category->title,'15') }}</li>
                              @endforeach
                            </ul>
                          </div>
                  ...
                  <div class="card">
                        ...
                        <div class="row">
                          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 p-1 mb-2">
                            ...
                            <div class="product-sub-categories" style="height: 50px;">
                              <ul>
                                @foreach($product->sub_categories->take(3) as $sub_category)
                                <li  style="font-weight: 200;" class="btn btn-sm btn-outline-dark text-capitalize p-1 m-1">{{ str_limit($sub_category->title,'15') }}</li>
                                @endforeach
                              </ul>
                            </div>
                    ...
                    <div class="card-footer p-0 m-0">
                      ...
                      <div class="cart-link pt-2 mt-2">
                        <a class="btn btn-block btn-lg btn-outline-dark " href="#">Add To Cart</a>
                      </div>
                    </div>
                  </div>
            		</div>
        ...
        <div class="col-12">
          <div class="card-link text-center">
            <a class="btn btn-lg  btn-outline-dark text-center"
              href="{{ route('web_product.index') }}"><strong>Find Out More</strong>
