      ...
      <div class="card ui-tab-card">
        <div class="tab-content">
          <div class="tab-pane fade show active" id="tab1" role="tabpanel">
            <div class="card-body">
              <form class="pt-2"  
                id="createBookingVenueForm" 
                action="{{route('booking_venue.store')}}" enctype="multipart/form-data" method="POST"
              >
                @csrf
                @if ($errors->any())
                ...
                <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                    ...
                    <div class="form-row">
                      <div class="form-group col-12 m-0 pt-3">
                        <label for="street"  class="col-form-label s-12">
                          Street 
                        </label>
                        <input 
                          id="street" 
