...
<div class="card height-auto" id="index-card">
  <div class="card-body">
    <form class="pt-2" data-async data-target="#create" id="productForm" enctype="multipart/form-data" 
      action="{{ route('product.update',['id' => $product->id]) }}" novalidate_lpchecked="1" 
      method="POST"
    >
      @csrf
      @if ($errors->any())
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
          <div class="form-row">
            <div class="form-group col-12 m-0 pt-3">
              ...
              <input id="name" name="name" autofocus value="{{ $product->name }}" maxlength="50" placeholder="{{ $product->name }}"
          ...
          <div class="form-row">
            <div class="form-group col-12 m-0 pt-3">
              ...
              <input id="sku" name="sku" autofocus value="{{ $product->sku }}" maxlength="50" placeholder="{{ $product->sku }}"
          ...
          <div class="form-row">
            <div class="form-group col-12 m-0 pt-3">
              ...
              <input id="unit_price" name="unit_price" autofocus value="{{ $product->unit_price }}" maxlength="50" placeholder="{{ $product->unit_price }}"
          ...
          <div class="form-row">
            <div class="form-group col-12 m-0 pt-3">
              ...
              <input id="size" name="size" autofocus value="{{ $product->size  }}" maxlength="50" placeholder="{{ $product->size }}"
          ...
          <div class="form-row">
            <div class="form-group col-12 m-0 pt-3">
              ...
              <input id="credit_price" name="credit_price" autofocus value="{{ $product->credit_price }}" maxlength="50" placeholder="{{ $product->credit_price }}"
          ...
          <div class="form-row">
            <div class="form-group col-12 m-0 pt-3">
              ...
              <input id="quantity" name="quantity" autofocus value="{{ $product->quantity }}" maxlength="50" placeholder="{{ $product->quantity }}"
          ...
          <div class="form-row">
            <div class="form-group col-12 m-0 pt-3">
              ...
              <input id="stock" name="stock" autofocus value="{{$product->stock }}" maxlength="50"
          ...
          <div class="form-row">
            <div class="form-group col-12 m-0 pt-3">
              ...
              <textarea style="height: 145px;" name="description" value="{{ $product->description }}"
          ...
          <div class="form-row mt-1">
            <div class="form-group col-12 m-0">
              <label class="my-1 mr-2 pt-3" for="brand_id">Brand * <span class="ml-3">{{ $product->brand->name }}</span></label>
          ...
          <div class="form-row mt-1">
            <div class="form-group col-12 m-0">
              <label class="my-1 mr-2 pt-3" for="color_id">Colors * <span class="ml-3">{{ $product->color->name }}</span></label>
          ...
          <div class="form-row mt-1">
            <div class="form-group col-12 m-0">
              <label class="my-1 mr-2 pt-3" for="store_id">Store * <span class="ml-3">{{ $product->store->name }}</span></label>
          ...
          <div class="form-row mt-1">
            <div class="form-group col-12 m-0">
              <label class="my-1 mr-2 pt-3" for="licensor_id">Licensor * <span class="ml-3">{{ $product->licensor->name }}</span></label>
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 pt-4">
          <div class="row product-images">
            ...
            <div class="col-md-12 product-avatar-up pl-0">
              <input  type="file" id="product_avatar" name="product_avatar" value="{{ $product->product_avatar }}">
              <div class="dropzone dropzone-file-area pt-4 pb-4 dz-clickable" id="product-avatar-up">
                ...
                @if(old('product_avatar'))
                    <img style="background-color: #eee" class="text-center img-responsive" src="{{ URL::asset('assets/images/products/'.$product->product_avatar) }}" required class="form-control r-0 light s-12  @error('product_avatar') is-invalid @enderror" />
                @endif
               
            
            <div class="col-md-12 col-lg-12 avatar-up pl-0">
              <input  type="file" id="avatar" name="avatar" value="{{ $product->avatar }}">
              <div class="dropzone dropzone-file-area pt-4 pb-4 dz-clickable" id="product-avatar-up">
                <div style="" class="dz-preview dropzone-previews"></div>
                <div class="dz-default dz-message">
                    <div>Upload Logo Image</div>
               ...
               @if(old('avatar'))
                    <img style="background-color: #eee" class="text-center img-responsive" src="{{ URL::asset('assets/images/products/'.$product->avatar) }}" required class="form-control r-0 light s-12  @error('avatar') is-invalid @enderror" />
                @endif
            </div>
          </div>
        </div>
