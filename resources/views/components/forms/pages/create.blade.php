      ...
      <div class="card ui-tab-card">
        <div class="tab-content">
          <div class="tab-pane fade show active" id="tab1" role="tabpanel">
            <div class="card-body">
              <form class="pt-2"  id="createPageForm" action="{{route('page.store')}}"  method="POST">
                @csrf
                @if ($errors->any())
                  ...
                  <div class="col-md-12">
                    <div class="col-md-3 pt-4">
                      <div class="col-md-12 store-up pl-0">
                        ...
                        <div class="dropzone dropzone-file-area pt-4 pb-4 dz-clickable" id="page-avatar-up">
                          <div style="" class="dz-preview dropzone-previews"></div>
                          <div class="dz-default dz-message">
                            <div>Upload Page Image</div>
