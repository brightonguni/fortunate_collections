<!-- Delete User Modal -->
<div class="modal fade" id="delete-service-category" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
                    ...
                    <div role="alert" class="alert p-0 p-4">
                      ...
                      <form method="POST" action="{{ route('service.delete','id') }}">
                        <div class="text-center message-box-wrap">
                          ...
                          <h4 class="my-3">Are you sure you want to delete this Service category?</h4>
