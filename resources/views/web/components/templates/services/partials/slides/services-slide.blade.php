  ...
  {{-- <ol class="carousel-indicators">
    ...
    @endforeach
      ...
      <div class="carousel-inner m-0 p-0  container-overlay">
        @foreach($services->take(5) as $slide)
          <div class="carousel-item slide-item-image {{ $loop->first ? ' active' : '' }} fade-in" style="background-image: url('{{ asset('assets/images/services/'.$slide->avatar)}}');" aria-label="slide-slide">
              ...
              <div class="slider-content  col-xs-12 col-sm-12 col-md-9 offset-md-3 col-lg-9 offset-lg-3 pt-0 mt-0">
                ...
                <div class="slide-url pt-3 pb-3">
                  <a class="btn btn-lg gradient-pastel-green pl-5 pr-5"  
                    href="{{ route('web_service.show',['id' =>$slide->id]) }}">
                    Find Out More
                  </a>
                </div>
              </div>
