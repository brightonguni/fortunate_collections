          ...
          @foreach($sub_categories as  $sub_category)
            <tr>
              ...
              <td>
                ...
                src="{{asset('assets/images/products/sub-category'.$sub_category->avatar)}}" 
                alt=""
              >
                {{ $sub_category->title}}
              </td>
              ...
              <td>
                @component('components.menus.projects.sub-categories', ['canDo' => $canDo])
                  @slot('id')
                    {{$sub_category->id}}
                  @endslot
                  project sub category-Menu Component
                @endcomponent
              </td>
            </tr>
          @endforeach
