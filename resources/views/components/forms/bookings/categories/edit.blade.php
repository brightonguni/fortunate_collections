<form class="pt-2" data-async data-target="#edit" id="BookingCategoryDetailsForm" enctype="multipart/form-data"
    action="/booking/category{{$category->id}}" novalidate _lpchecked="1" method="POST" enctype="multipart/form-data">
    @csrf
