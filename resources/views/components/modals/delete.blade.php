                  ...
                  <div class="col-md-12">
                    <div role="alert" class="alert p-0 p-4">
                      <button type="button" class="close" id="close-btn" data-dismiss="modal"
                        ...
                        class="icon text-primary icon-close2"></i></span>
                      </button>
                                ...
                                <div class="item-content">
                                    <div class="item-icon">
                                        <i class="fas fa-exclamation-circle"></i>
                                                  ...
                                                  <h4 class="my-3">Are you sure you want to delete ?</h4>
                                                  <p>If you delete, you will permanently lose your data</p>
                                                  {{-- <button type="button submit" id="delete-btn" data-target-id="{{ {$id} }}" class="delete_btn btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Delete</button>  --}}
