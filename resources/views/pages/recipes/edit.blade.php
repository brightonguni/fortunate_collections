...
@section('content')
    ...
    <div class="breadcrumbs-area">
        ...
        <ul>
            ...
            <li>
                <a href="/recipe/{{ $recipe->id }}">Details</a>
            </li>
            <li>Edit Team</li>
        </ul>
    </div>
            ...
            <div class="card ui-tab-card">
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="tab1" role="tabpanel">
                        <div class="card-body">
                            @component('components.forms.recipes.edit',[ 'recipe' => $recipe, 'licensors'=>$licensors,'recipes_category'=>$recipes_category,'stores'=>$stores, 'canDo' => $canDo])
                                recipes Edit Form Component
                            @endcomponent
                        </div>
                    </div>
                </div>
